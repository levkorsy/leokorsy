$(function() {
    ...
    // $('.first-btn').mouseenter(
    //   function () {
    //     console.log("btn hover");
    //     console.log($("#arrow-in-btn"));
    //     $("#arrow-in-btn").removeClass("fa-arrow-right");
    //     $("#arrow-in-btn").addClass("fa-arrow-down"); 
    //   }
    // )
    // $('.first-btn').mouseleave(
    //   function () {
    //     $("#arrow-in-btn").removeClass("fa-arrow-down");
    ...
    $('#contact-form').submit(function(e) {
      ...
      $.ajax({
        url: 'https://formspree.io/f/xrgolzra',
        method: 'POST',
